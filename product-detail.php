  ...
  <section class="detail">
    ...
    <div class="product-details">
      ...
      <p class="product-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        ...
        voluptatibus mollitia unde, maxime ad ipsa praesentium repellat dolor! Distinctio.</p>
      <h5 class="product-model">Model</h5>
      <input class="product-model" type="radio" name="product-custom-model" id="product-model">
